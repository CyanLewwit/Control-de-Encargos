...
public class Gestionar_Usuarios extends javax.swing.JFrame {
    ...
    public Gestionar_Usuarios() {
        ...
        Icon icono = new ImageIcon(wallpaper.getImage().getScaledInstance(Label_wallp.getWidth(), Label_wallp.getHeight(), Image.SCALE_DEFAULT));
        Label_wallp.setIcon(icono);
        this.repaint();
        
        
        Conexion cn=new Conexion();
        try {
            String sql="select id_usuario, nombre_usuario, username, tipo_nivel, estatus from usuarios;";
        ...
        Tabla_usuarios.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent e){
                ...
                if(fila_point>-1){
                    ...
                    Info_usuarios inf=new Info_usuarios();
                    inf.setVisible(true);
                }
    ...
    private void initComponents() {
        ...
        Label_wallp = new javax.swing.JLabel();
        ...
        getContentPane().add(Label_wallp, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 630, 330));
    ...
    private javax.swing.JLabel Label_wallp;
