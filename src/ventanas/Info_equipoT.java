...
public class Info_equipoT extends javax.swing.JFrame {

    int IDequipo;
    String user;
    
    public Info_equipoT() throws Exception {
        initComponents();
        user=Login.user;
        IDequipo=Gestionar_Eq.IDequipo_update;
        ...
        setTitle("Equipo con el ID "+IDequipo+" - Sesion de "+user);
    ...
    private void initComponents() {
        ...
        But_ActualizarCom = new javax.swing.JButton();
        ...
        txtpane_observaciones.setEditable(false);
        ...
        But_ActualizarCom.setBackground(new java.awt.Color(153, 153, 255));
        But_ActualizarCom.setFont(new java.awt.Font("Arial Narrow", 0, 18)); // NOI18N
        But_ActualizarCom.setForeground(new java.awt.Color(255, 255, 255));
        But_ActualizarCom.setText("Comentar/Actualizar");
        But_ActualizarCom.setBorder(null);
        But_ActualizarCom.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                But_ActualizarComActionPerformed(evt);
            }
        });
        getContentPane().add(But_ActualizarCom, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 400, 210, 35));
    ...
    private void But_ActualizarComActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_But_ActualizarComActionPerformed

      String sta,c_t,T;
      
      sta=cmb_estatus.getSelectedItem().toString();
      c_t=txtpane_comTec.getText();
      T=user;
      Conexion cn=new Conexion();
      
        try {
            String sql="update equipos set estatus = \""+sta+"\", comentarios_tecnicos"
                    + " = \""+c_t+"\", revision_tec_de = \""+T+"\" where id_equipo = \""+IDequipo+"\";";
            cn.insertarModificarEliminar(sql);
            JOptionPane.showMessageDialog(null, "Actualizacion exitosa");
            this.dispose();
        } catch (SQLException e) {
            System.err.println("Error al Actualizar equipo "+e);
            JOptionPane.showMessageDialog(null, "Error al actualizar equipo. Contacte al Admin");
        } catch (Exception ex) {
            Logger.getLogger(Info_equipoT.class.getName()).log(Level.SEVERE, null, ex);
        }
      
    }//GEN-LAST:event_But_ActualizarComActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Info_equipoT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Info_equipoT().setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(Info_equipoT.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    private javax.swing.JButton But_ActualizarCom;
